...
print $2,$4,$5,c,a[1],a[6],b[2],b[3],b[1]}' "$FILE" |\
sed 's/=/ /g' |\
awk '$9~"," {sub(/^[0-9]*,/, "", $9)} {print $1,$2,$3,$4,$6,$8,$10,$9,$11}' |\
awk '$0!~"," {$8/=$7;print} $0~"," {n=split($3,a,",");split($8,b,",");for(i=1;i<=n;i++) print $1,$2,a[i],$4,$5,$6,$7,b[i]/$7,$9}' |\
awk '$8>0.1'
